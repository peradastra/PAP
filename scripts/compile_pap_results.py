...
def determine_diagnostic_result(breadth_of_coverage):
...
def compile_results_into_file(library_name, top_directory):
    ...
    path_to_qc_result = str(top_directory) + "/final/qc_stats.txt"
    ...
    diagnostic_result_var = determine_diagnostic_result(breadth_of_coverage_var)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Compile PAP results and QC data')
